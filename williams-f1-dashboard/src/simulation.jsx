  ...
  return (
    <div className="h-full w-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 p-4 md:p-8">
      <div className="flex flex-col gap-6 md:gap-8 w-full max-w-[1800px] mx-auto">
        ...
        {/* Main content */}
        <div className="flex flex-col lg:flex-row gap-6 md:gap-8 w-full" style={{ minHeight: '720px' }}>
          {/* Leaderboard */}
          <div
            className="w-full lg:w-[20%] border border-gray-700 rounded-lg p-3 bg-gray-900 flex flex-col"
          ...
          {/* Race Track */}
          <div className="w-full lg:w-[80%] bg-white rounded-2xl shadow-2xl p-4 md:p-8 relative">
